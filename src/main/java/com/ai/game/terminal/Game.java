...
//        ((AbstractAIPlayer) player1).buildOrderType(MoveOrderType.PreferMiddleOfBoard);
        ...
        ((AbstractAIPlayer) player2).buildStrategy(Strategy.NotLastButOneInLine)
        .buildIfSameValuesType(MoveIfSameValues.Random).buildOrderType(MoveOrderType.PreferMiddleOfBoard);
